# Simple Android App Build Script
Write-Host "========================================" -ForegroundColor Green
Write-Host "Android App Build Script" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green

# Check if version arguments are provided
if ($args.Count -lt 2) {
    Write-Host "Usage: .\build-simple.ps1 [version_code] [version_name]" -ForegroundColor Red
    Write-Host "Example: .\build-simple.ps1 2 1.1.0" -ForegroundColor Red
